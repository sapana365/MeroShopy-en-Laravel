            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>Mero<strong>Shop</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> pokhara-15, Nepal</p>
                      <p><span class="fa fa-phone"></span>+977 980567898</p>
                      <p><span class="fa fa-envelope"></span>meroshop@gmail.com</p>
                    </address>
